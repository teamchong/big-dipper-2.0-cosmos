...
export const lightTemplate: ThemeOptions = R.mergeDeepLeft(
  lightThemeOverride,
  common
);
export const darkTemplate: ThemeOptions = R.mergeDeepLeft(
  darkThemeOverride,
  common
);
...
export const tritanopiaTemplate: ThemeOptions = R.mergeDeepLeft(
