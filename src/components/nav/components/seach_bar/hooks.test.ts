...
describe("misc: useSearchBar", () => {
  it("use a validator address", async () => {
    ...
    act(() => {
      result.current.handleOnSubmit(
        "desmosvaloper1jrld5g998gqm4yx26l6cvhxz7y5adgxqzfdpes"
      );
    });
  ...
  it("use a consensus address", async () => {
    ...
    act(() => {
      result.current.handleOnSubmit(
        "desmosvalcons1rzhewpmmdl72lhnxj6zmxr4v94f522s4hyz467"
      );
    });
  ...
  it("use a user address", async () => {
    ...
    act(() => {
      result.current.handleOnSubmit(
        "desmos1jrld5g998gqm4yx26l6cvhxz7y5adgxquy94nz"
      );
    });
    expect(mockPush).toBeCalledWith(
      "/accounts/desmos1jrld5g998gqm4yx26l6cvhxz7y5adgxquy94nz"
    );
  });
